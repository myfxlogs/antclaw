...
CREATE INDEX idx_events_updated ON calendar_events (updated_at DESC);
...
CREATE INDEX idx_impact_event ON event_impact_records (event_id, recorded_at DESC);
CREATE INDEX idx_impact_symbol ON event_impact_records (symbol, recorded_at DESC);
...
CREATE INDEX idx_speeches_published ON fed_speeches (published_at DESC);
CREATE INDEX idx_speeches_tone ON fed_speeches (tone, published_at DESC);
...
CREATE INDEX idx_titles_event ON calendar_event_titles (event_id);
